    ...
    render() {
        ...
        return (
            <Panel id={id}>
                ...
                <Group header={<Header mode="secondary">«Андреевская слобода»</Header>}> 
                    <CardGrid size="l">
                        <ContentCard
                ...
                <Group header={<Header mode="secondary">Режим работы</Header>}> 
                    <MiniInfoCell
                        ...
                        textLevel="primary"
                        >
                            Со вторника по воскресенье, с 11:00 до 19:00, касса до 18:00. 
                    </MiniInfoCell>
                </Group>
                ...
                <Group header={<Header mode="secondary">Официальный сайт</Header>}> 
                    <MiniInfoCell
                        ...
                        textLevel="primary"
                        >
                            <Link target="_blank" href="https://www.belokurikha.ru">https://www.belokurikha.ru</Link>
                    </MiniInfoCell>
                </Group>
